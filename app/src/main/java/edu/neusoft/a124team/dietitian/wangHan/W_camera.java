...
public class W_camera extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_w_camera);

        takePicBtn = (Button) findViewById(R.id.w_btn_photo);
        takePicBtn.setOnClickListener(takePiClickListener);

        takeVideoBtn = (Button) findViewById(R.id.w_btn_video);
